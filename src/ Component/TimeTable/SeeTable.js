...
function SeeTable(props) {
  ...
  useEffect(() => {
    Axios.get(`/api/seetimetable/${empId}`).then((response) => {
  ...
  function getList() {
    ...
    fetch(`http://localhost:3001/api/seetimetablex/${empId}/${dday}`).then(
      (result) => {
