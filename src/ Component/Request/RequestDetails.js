                    ...
                    <table style={{ width: '550px', height: '100%', marginLeft: '25px', marginBottom: '20px' }}>
                      ...
                      <tr> <td>
                        ...
                        <p style={{ textAlign: 'left' }}>
                          {new Date(val.fromDate).toLocaleDateString('en-GB')} - {new Date(val.toDate).toLocaleDateString('en-GB')}
                        </p>
                      </td></tr>
                      ...
                      <tr><td>
                        ...
                        <span>{new Date(val.applicationDate).toLocaleDateString('en-GB')}</span>
