...
app.post('/api/insertLeaveRequest', (req, res) => {
   ...
   // const department = req.body.department;
    ...
    const leaveRequest = "INSERT INTO LeaveRequest(empId, leaveType, applicationDate, fromDate, toDate, reason,LeavealrdytakncrrntmonthCL, LeavealrdytakncrrntmonthLWP,TillprevsmonthleavetakenCL,TillprevsmonthleavetakenLWP,BalenaceleaveexcludingthisleaveCL) VALUES (?,?,?,CURDATE(),?,?,?,?,?,?,?);";
